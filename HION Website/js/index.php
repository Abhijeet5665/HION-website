...
<body><center>
    <div id="wrapper">
        <h1><a href="index.php">Online Code Compiler</a></h1>
        <form id="code" action="#" method="post">
            ...
            <div>
                ...
                <textarea class="span6" cols="40" rows="10" name="source" id="source" placeholder="Paste/Type Code Here"></textarea>
            </div>
        ...
        <div id="footer">
            &copy 2013 <a href="http://startupcluster.org">Himanshu Jaju</a> </div>
    </div>
